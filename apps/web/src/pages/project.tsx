...
import { ArrowLeft, Grid, Play, RefreshCw } from "lucide-react";
    ...
    <div className="h-screen w-screen bg-slate-100 dark:bg-slate-950 text-slate-800 dark:text-slate-100 flex flex-col overflow-hidden select-none">
      ...
      <main className="flex-1 flex w-full h-[calc(100vh-56px)] overflow-hidden relative">
        ...
        <div
          ...
          className="h-full shrink-0 flex flex-col min-w-[180px] max-w-[450px]"
        >
          <LayerTree
        ...
        <div
          ...
          className="h-full shrink-0 flex flex-col min-w-[240px] max-w-[500px]"
        >
          <ElementManager
            layer={selectedLayer}
